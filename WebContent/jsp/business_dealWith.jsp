    ...
    <div class="content">
        ...
        <div class="add_delivery_notice">
            <div class="box">
                ...
                <div class="box_c">
                    <form action="${pageContext.request.contextPath }/businessDealWith.action" method="post">
                        <fieldset>
                    ...
                    <select class="text_input w200 fl" id="businessstateS" name="businessstateS" >
                          	<option  selected value="2">待处理</option>
            ...
            <div class="box">
                ...
                <div class="box_c box_c_reset">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                |<a href="#" onclick="updateBusinessToOn(${business.id})">处理</a>
                                |<a href="#" onclick="updateBusinessToFinish(${business.id})">完成</a>
					...
					<div class="clear"></div>
                    <!-- 页码框选项，与页面跳转实现 -->
					<itcast:page url="${pageContext.request.contextPath }/businessDealWith.action" />
