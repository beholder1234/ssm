...
<%-- 	<form id="check"
	...
	<form id="check"
		action="${pageContext.request.contextPath }/orderPPurchaseList.action"
		method="post">
		<table width="100%">
			<tr>
			
				<td>
				<input class="text_input w150" type="hidden" name="which"  value="orderPPurchaseList"  > 
				</td>
			</tr>
			<tr>
				<td colspan="2" align="center"><input type="submit" value="提交" />
    ...
    <div class="content">
        ...
        <div class="add_delivery_notice">
            <div class="box">
                ...
                <div class="box_c">
                    <form action="${pageContext.request.contextPath }/orderPPurchaseList.action" method="post">
                        <fieldset>
                            ...
                            <div class="box_c_item">
                                    ...
                                    <input class="text_input w200 fl" type="text" name="Emp1S" id="Emp1S" placeholder="请输入下单员"> 
                                    <label class="l_title">审核员：</label>
                                    <input class="text_input w200 fl" type="text" name="Emp2S" id="Emp2S" placeholder="请输入审核员"> 
...
<!--                             <div class="box_c_item">
            ...
            <div class="box">
                ...
                <div class="box_c box_c_reset">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td ><fmt:formatDate value="${order.checktime }" pattern="yyyy-MM-dd"/></td>
                                <td>${order.totalprice }</td>
								<td>取货</td>
                                <td class="text-right"><a href="#" onclick="getOrderdetailList(${order.id})">订单明细</a>  | <a href="#" onClick="finishPur(${order.id},${oneRole.id })">采购完成</a>
                                </td>
                            </tr><!-- 最多7行 -->
                            </c:forEach>
                        </tbody>
					...
					<div class="clear"></div>
                    <!-- 页码框选项，与页面跳转实现 -->
					<itcast:page url="${pageContext.request.contextPath}/orderPPurchaseList.action" />
...
function finishPur(orderId,starterId){
	
	var r=confirm("确定完成采购吗？？？");	
	
	if(r){
 	$.ajax({
 		type : "POST",
 		url : "finishPur.action",
 		dataType : "json",
 		cache : false,
 		async:false,
