...
<%-- 
	...
	<form id="check"
		action="${pageContext.request.contextPath }/orderSCheckList.action"
		method="post">
		<table width="100%">
			<tr>
    ...
    <div class="content">
        ...
        <div class="add_delivery_notice">
            <div class="box">
                ...
                <div class="box_c">
                    <form action="${pageContext.request.contextPath }/orderSCheckList.action" method="post">
                        <fieldset>
                            
                            
                            <div class="box_c_item">
                                    <label class="l_title">客户：</label>
                                    <input class="text_input w200 fl" type="text" name="customerS" id="customerS" placeholder="请输入公司名称"> 
...
<!--                             <div class="box_c_item">
            ...
            <div class="box">
                ...
                <div class="box_c box_c_reset">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
								...
								<td>审核</td>
                                <td class="text-right"><a href="#" onclick="getOrderdetailList(${order.id})">订单明细</a> | <a href="#" onClick="verifySOrder(${order.id},${oneRole.id })">审核</a>
                                </td>
                            </tr><!-- 最多7行 -->
                            </c:forEach>
                        </tbody>
					...
					<div class="clear"></div>
                    <!-- 页码框选项，与页面跳转实现 -->
					<itcast:page url="${pageContext.request.contextPath }/orderSCheckList.action" />
...
function verifySOrder(orderId,checkerId){
