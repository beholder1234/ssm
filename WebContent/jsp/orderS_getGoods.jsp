...
<%-- 	<form id="check"
	...
	<form id="check"
		action="${pageContext.request.contextPath }/orderSGetGoodsList.action"
		method="post">
		<table width="100%">
			<tr>
    ...
    <div class="content">
        ...
        <div class="add_delivery_notice">
            <div class="box">
                ...
                <div class="box_c">
                    <form action="${pageContext.request.contextPath }/orderSGetGoodsList.action" method="post">
                        <fieldset>
                            ...
                            <div class="box_c_item">
                                    ...
                                    <input class="text_input w200 fl" type="text" name="Emp2S" id="Emp2S" placeholder="请输入公司名称"> 
...
<!--                             <div class="box_c_item">
            ...
            <div class="box">
                ...
                <div class="box_c box_c_reset">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td ><fmt:formatDate value="${order.starttime }" pattern="yyyy-MM-dd"/></td>
                                <td>${order.totalprice }</td>
								<td>取货</td>
                                <td class="text-right"><a href="#" onclick="getOrderdetailList(${order.id})">订单明细</a>  | <a href="#" onClick="startGetGoods(${order.id},${oneRole.id})">销售完成</a>
                                </td>
                            </tr><!-- 最多7行 -->
                            </c:forEach>
                        </tbody>
					...
					<div class="clear"></div>
                    <!-- 页码框选项，与页面跳转实现 -->
					<itcast:page url="${pageContext.request.contextPath}/orderSGetGoodsList.action" />
...
function startGetGoods(orderId,starterId){
	
	var r=confirm("确定开始取货吗？？？");	
	
	if(r){
 	$.ajax({
 		type : "POST",
 		url : "startGetGoods.action",
 		dataType : "json",
 		cache : false,
 		async:false,
