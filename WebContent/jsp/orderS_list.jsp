...
<%-- 	<form id="check"
	...
	<form id="check"
		action="${pageContext.request.contextPath }/orderSList.action"
		method="post">
		<table width="100%">
			<tr>
    ...
    <div class="content">
        ...
        <div class="add_delivery_notice">
            <div class="box">
                ...
                <div class="box_c">
                    <form action="${pageContext.request.contextPath }/orderSList.action" method="post">
                        <fieldset>
            ...
            <div class="box">
                ...
                <div class="box_c box_c_reset">
					...
					<div class="clear"></div>
                    <!-- 页码框选项，与页面跳转实现 -->
					<itcast:page url="${pageContext.request.contextPath }/orderSList.action" />
