    ...
    <div class="content">
        ...
        <div class="add_delivery_notice">
            <div class="box">
                ...
                <div class="box_c">
                    <form action="${pageContext.request.contextPath }/orderList.action" method="post">
                        <fieldset>
                        ...
                        <input class="text_input w150" type="hidden" name="which"  value="orderList"  > 
                            ...
                            <div class="box_c_item">
                                    ...
                                    <label class="l_title">订单类型：</label>
                    <select class="text_input w200 fl" id="ordertypeS" name="ordertypeS" >
                          <option selected  style="display:none" value="" >请选择...</option>
                          <c:forEach items="${ordertypes }" var="ordertype">
                          	<option value="${ordertype.valueid }" >${ordertype.valuename }</option>
                          </c:forEach>
                    </select>            
            ...
            <div class="box">
                ...
                <div class="box_c box_c_reset">
					...
					<div class="clear"></div>
                    <!-- 页码框选项，与页面跳转实现 -->
					<itcast:page url="${pageContext.request.contextPath }/orderList.action" />
